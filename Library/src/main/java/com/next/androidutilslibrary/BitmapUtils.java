...
{
	// TODO: This class might be called effectUtils.java in future
	private BitmapUtils()
	{
	...
	public static Bitmap addCornerBorder(final Bitmap src, @IntRange(from = 1) final int borderSize, @ColorInt final int color,
	                                     @FloatRange(from = 0) final float cornerRadius, final boolean recycle)
	{
	...
	public static Bitmap fastBlur(final Bitmap src, @FloatRange(from = 0, to = 1, fromInclusive = false) final float scale,
	...
	// Todo: this method is general for alot of util libs. move to GeneralUtils.java
